...
module CareRequestListable
  ...
  #   care_requests_by_status = Procedure.where(care_status: care_status, region: region)
  #   care_requests_by_status
  # end
  ...
  #   # assigned_care_requests = find_care_request_by_status(region, Procedure.care_statuses[:coordinator_assigned])
  #   assigned_care_requests = Procedure.where(care_status: :coordinator_assigned, region: region)
