class NewCareAddressForm
  include ActiveModel::Model

  include PhoneCleanable

  attr_accessor :region_id, :org_id, :patient_id, :procedure_id, :street_address, :city, :state, :zip, :closest_cross_street,
                :phone_number, :start_date, :end_date, :confirmed, :coordinates, :qc_house, :accessibility_options
