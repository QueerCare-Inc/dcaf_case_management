namespace :fund_management do
  ...
  def print_counts
    ...
    models_fund_dependent = [ ArchivedPatient, Patient, Fulfillment, PledgeConfig, ExternalPledge, PracticalSupport, Note, Call, Event, CallListEntry, Clinic, Region, Config, User ]
    starting_counts = {}
